      ...
      <section className="product-layout" aria-label="Detalhes do produto">
        ...
        <article className="product-info">
          ...
          <div className="product-actions">
            {!produto.is_feito_a_mao && (
              <button
                type="button"
                className={`product-cart-button ${isInCart(produto.id) ? 'is-in-cart' : ''}`}
                onClick={() => {
                  if (isInCart(produto.id)) {
              ...
              >
                ...
                {isInCart(produto.id) ? 'Adicionado' : 'Adicionar à lista'}
              </button>
            )}
            ...
            <a
              ...
              onClick={(event) => { if (isReserved) event.preventDefault() }}
            >
              <svg viewBox="0 0 24 24" aria-hidden="true">
